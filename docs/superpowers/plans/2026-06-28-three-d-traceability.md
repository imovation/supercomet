...
- [ ] **Step 3: 实现 .comet.yaml tasks 段行级解析器**
...
- [ ] **Step 4: 实现正向查询（--requirement-id）缩进树输出**
...
- [ ] **Step 5: 验证正向查询（使用手动构造的测试 .comet.yaml）**
...
- [ ] **Step 1: 创建 comet-state-set-task.sh 骨架**
...
- [ ] **Step 4: 验证 set-task 写入——tasks 段不存在时追加**
...
- [ ] **Step 5: 验证 set-task 追加 commit——task 已存在时**
...
- [ ] **Step 1: 创建 comet-guard-check-commits.sh**
...
- [ ] **Step 3: 验证闸门——所有 task 都有 commits 时 PASS**
...
- [ ] **Step 4: 验证闸门——存在空 commits 时 BLOCKED**
...
- [ ] **Step 1: 创建 BATS 测试文件骨架和 setup/teardown**
...
- [ ] **Step 2: 编写场景 1——正向查询（按 Requirement ID）**
...
- [ ] **Step 3: 编写场景 2——反向查询（按 commit hash）**
...
- [ ] **Step 4: 编写场景 3——无效 Requirement ID**
