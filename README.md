...
```bash
git clone https://github.com/imovation/supercomet.git
cd supercomet
npm install -g .
```
...
`supercomet init` 将所有增强脚本和 Skill 文件部署到当前项目的 `comet/scripts/` 和 `comet/reference/` 目录。
